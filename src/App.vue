...
<template>
 ...
 <Photos
   ...
   text="Фитографии интересны с точки зрения архитектуры и ракурса"
   />
 <Photos
     header="Выпускной"
     urls="https://img3.fonwall.ru/o/dc/acura-nsx-honda-cars.jpeg?route=thumb&h=350"
     text="Фитографии интересны с точки зрения архитектуры и ракурса"
     />
 <Photos @comCreated="coments.push($event)"/>
